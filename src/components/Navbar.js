                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li><Link className='dropdown-item' to="/login"><button type="button" onClick={logoutHandler} className="btn" style={{ backgroundColor: "#7532F9", color: "white" }}>Logout</button></Link></li>
                                </ul>
                            </li>
                        </ul>
